...
var file_shortener_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa3, 0x02, 0x0a, 0x10, 0x53, 0x68, 0x6f,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x17,
...
var file_shortener_service_proto_goTypes = []interface{}{
	...
	(*CreateShortUrlResponse)(nil), // 3: auth_service.CreateShortUrlResponse
	(*GetShortUrlResponse)(nil),    // 4: auth_service.GetShortUrlResponse
...
var file_shortener_service_proto_depIdxs = []int32{
	...
	3, // 3: auth_service.ShortenerService.CreateShortUrl:output_type -> auth_service.CreateShortUrlResponse
	4, // 4: auth_service.ShortenerService.GetShortUrl:output_type -> auth_service.GetShortUrlResponse
	5, // 5: auth_service.ShortenerService.IncClickCount:output_type -> auth_service.IncClickCountResponse
